...
export default component$<BlogMeta>((props) => {
  return (
    <section class="rounded-md bg-base-200 border-primary/50 border w-full p-4 flex flex-col space-y-8">
      ...
      <span class="font-bold text-2xl md:text-4xl">{props.title}</span>
