...
target this disparity in income, for the vast majority of applicants
getting into an Ivy League/Ivy+ School is essentially a gamble for CS students.
I believe my own case reflects this.

## The Schools I Applied to & My Stats

All in all, I applied to 18 total schools - 2 safeties and 16 reaches. Insanity.

Here are the schools I applied to and their decisions:

<img src={college} style={{ width: 'auto', height: 'auto' }} />

Going in to the 2024 application cycle, I applied to these schools with the following stats: 
Rank 4/743, a 35 ACT (equivalent to a 1560-1590 SAT), and a 4.5 Weighted GPA. 
